...
public class Coordination implements Runner {
    ...
    public static void main(String[] args) throws Exception {
        ...
        pathMap.put(Constants.DISTINCT_RUNNER_INPUT, "/input/coordination/data");
        pathMap.put(Constants.DISTINCT_RUNNER_OUTPUT, "/output/coordination/distinct");

        pathMap.put(Constants.SCORE_RUNNER_INPUT, pathMap.get(Constants.DISTINCT_RUNNER_OUTPUT));	//后面每一步的输入路径都是前一步的输出路径
        pathMap.put(Constants.SCORE_RUNNER_OUTPUT, "/output/coordination/score");

        pathMap.put(Constants.VIEWER_RUNNER_INPUT, pathMap.get(Constants.SCORE_RUNNER_OUTPUT));
        pathMap.put(Constants.VIEWER_RUNNER_OUTPUT, "/output/coordination/viewer");

        pathMap.put(Constants.SINGLE_SCORE_RUNNER_INPUT_I, pathMap.get(Constants.SCORE_RUNNER_OUTPUT));
        pathMap.put(Constants.SINGLE_SCORE_RUNNER_INPUT_II, pathMap.get(Constants.VIEWER_RUNNER_OUTPUT));
        pathMap.put(Constants.SINGLE_SCORE_RUNNER_OUTPUT, "/output/coordination/single_score");

        pathMap.put(Constants.AVERAGE_RUNNER_INPUT, pathMap.get(Constants.SINGLE_SCORE_RUNNER_OUTPUT));
        pathMap.put(Constants.AVERAGE_RUNNER_OUTPUT, "/output/coordination/average");

        pathMap.put(Constants.TOP_RUNNER_INPUT, pathMap.get(Constants.AVERAGE_RUNNER_OUTPUT));
